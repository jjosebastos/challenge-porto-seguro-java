...
public class TecnicoDaoImpl implements TecnicoDao {
    ...
    @Override
    public Tecnico save(Tecnico tecnico, Connection connection) throws UnsupportedServiceOperationException, SQLException, TecnicoNotSavedException {
        final String sql = "BEGIN INSERT INTO T_CON_TECNICO (NM_TECNICO, DT_NASCIMENTO, NR_MATRICULA, ID_AUTORIZADA) VALUES (?,?,?,?,?) RETURNING ID INTO ?; END;";
            ...
            try (Connection conn = DatabaseConnectionFactory.create().get()){
                ...
                while (resultSet.next()){
                    Tecnico tecnico = new Tecnico(
                            ...
                            (LocalDate) resultSet.getObject("dt_nascimento"),
    ...
    public Tecnico update(Tecnico tecnico, Connection connection) throws TecnicoNotFoundException, SQLException {
        final String sql = "UPDATE T_CON_TECNICO SET NM_TENCICO = ?, " +
                "DT_NASCIMENTO = ?, NR_MATRICULA = ?, " +
