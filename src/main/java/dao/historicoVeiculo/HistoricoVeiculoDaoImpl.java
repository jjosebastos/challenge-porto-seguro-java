...
public class HistoricoVeiculoDaoImpl implements HistoricoVeiculoDao {
    ...
    @Override
    public HistoricoVeiculo create(HistoricoVeiculo historicoVeiculo, Connection connection) throws HistoricoVeiculoNotSavedException, SQLException, UnsupportedServiceOperationException {
        final String sql = "BEGIN INSERT INTO T_CON_HISTORICO_VEICULO (tp_evento,dt_evento,ds_evento,km_odometro, id_veiculo, id_autorizada) " +
    ...
    public HistoricoVeiculo update(HistoricoVeiculo historicoVeiculo, Connection connection) throws HistoricoVeiculoNotFoundException, SQLException {
        final String sql = "UPDATE T_CON_HISTORICO_VEICULO SET TP_EVENTO = ?, DT_EVENTO = ?, DS_EVENTO = ?, " +
                "KM_ODOMETRO = ?, ID_VEICULO = ?, AUTORIZADA = ?" +
