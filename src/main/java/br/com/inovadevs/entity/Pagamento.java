...
public class Pagamento {
    ...
    public Pagamento(Long idPagamento, String tipoPagamento, Date data, double valor, String status, String descricao, Long idPessoa, Long idSeguradora, Long idAutorizada) {
